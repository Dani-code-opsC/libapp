...
from LibUI import Ui_MainWindow
...
class MainApp(QMainWindow, Ui_MainWindow):
    ...
    def Handel_Button(self):
        ...
        self.pushButton_29.clicked.connect(self.Open_Clients_Tab)
        ...
        self.pushButton_80.clicked.connect(self.Login)
        ...
        self.pushButton_12.clicked.connect(self.Add_New_Clients)
        ...
        self.pushButton_26.clicked.connect(self.Export_Clients)
    ...
    def Delete_Books(self):
        ...
        warning = QMessageBox.warning(self, 'DELETE BOOK', "are you sure you want to delte this book", QMessageBox.Yes | QMessageBox.No)
    ...
    def Add_New_Clients(self):
        ...
        self.cur.execute('''INSERT INTO clients(client_name, client_email, client_nationalid)
        VALUES (%s,%s,%s)
    ...
    def Edit_Client(self):
        client_originalnationalid=self.lineEdit_28.text()
        ...
        ''', (client_name, client_email, client_nationalid,  client_originalnationalid))
        self.db.commit()
    ...
    def Delete_Client(self):
        ...
        warning_message = QMessageBox.warning(self, "Delete_Client", " are you sure you want to delete this client", QMessageBox.Yes|QMessageBox.No)
        ...
        if warning_message== QMessageBox.Yes:
            ...
            self.cur.execute(sql, [( client_originalnationalid)])
            self.db.commit()
            self.db.close()
    ...
    def Edit_User(self):
        ...
        password2 = self.lineEdit_20.text()
    ...
    def Show_Publisher_Combobox(self):
        ...
        for publisher in data:
            ...
            self.comboBox_9.addItem(publisher[0])
